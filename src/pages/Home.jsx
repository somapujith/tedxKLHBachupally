        ...
        <div className="relative z-10 w-full px-6 md:px-12 lg:px-20">
          <div className="max-w-xl">
            ...
            <p className="mt-6 max-w-md text-paper/70">
              Five ideas. One stage. A single day, staged and recorded for the world — built
      ...
      <Section divider={false}>
        <Reveal>
          ...
          <h2 className="mt-5 max-w-4xl font-display text-3xl leading-[1.1] tracking-tight md:text-5xl">
            We find five people worth listening to, and give each of them eighteen minutes
      ...
      <Section>
        <Reveal>
          ...
          <p className="mt-6 max-w-xl text-lg leading-relaxed text-paper/60">
            ...
            intelligence itself — and this year&rsquo;s five talks are our attempt at an answer.
          </p>
          <div className="mt-8">
